...
function App() {
  ...
  const [stockLevels, setStockLevels] = reactExports.useState(
    () => Object.fromEntries(PRODUCTS.map((p) => [p.id, p.stock]))
  );
  const [cartOpen, setCartOpen] = reactExports.useState(false);
  const [orderFormOpen, setOrderFormOpen] = reactExports.useState(false);
  const [logoZoom, setLogoZoom] = reactExports.useState(false);
  ...
  const [orderErrors, setOrderErrors] = reactExports.useState({});
  const [orderSent, setOrderSent] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const onScroll = () => {
  ...
  reactExports.useEffect(() => {
    if (!logoZoom) return;
    const t = setTimeout(() => setLogoZoom(false), 3e3);
  ...
  const addToCart = reactExports.useCallback(
    (product) => {
      ...
      setCart((prev) => {
        ...
        if (existing) {
          return prev.map(
            (i) => i.id === product.id ? { ...i, qty: i.qty + qty } : i
          );
        }
  ...
  const updateCartQty = (id, delta) => {
    setCart(
      (prev) => prev.map(
        (i) => i.id === id ? { ...i, qty: Math.max(1, i.qty + delta) } : i
      )
    );
  };
  ...
  const placeWhatsAppOrder = () => {
    ...
    const itemLines = cart.map((i) => `${i.name} - Qty: ${i.qty} - Rs.${i.price * i.qty}`).join("\n");
    const msg = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { backgroundColor: "#f5f1e8", minHeight: "100vh" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        style: {
          ...
          right: 0,
          zIndex: 100,
          backgroundColor: scrolled ? "rgba(15,61,46,0.97)" : "rgba(15,61,46,0.75)",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "Kishore Organic Soaps"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "Pure Luxury Herbal Soaps"
                    }
                  )
                ] })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.875rem" }, children: "Cart" }),
    ...
    logoZoom && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "dialog",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { id: "home", style: { position: "relative", zIndex: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  position: "absolute",
                  inset: 0,
                  backgroundImage: "radial-gradient(circle at 20% 50%, rgba(198,168,91,0.08) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(223,232,220,0.06) 0%, transparent 50%)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider", style: { width: 60 } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { size: 18, style: { color: "#c6a85b" } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider", style: { width: 60 } })
                      ] })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "h1",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { style: { color: "#c6a85b", fontStyle: "italic" }, children: "Herbal Soaps" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Handcrafted with ancient botanicals and pure natural ingredients. Experience the luxury of nature on your skin."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        "No Chemicals",
                        "Eco-Friendly"
                      ].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hero-badge", children: b }, b))
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: 56 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Each bar is handcrafted with premium botanicals for a truly luxurious bathing experience."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "products-grid", children: PRODUCTS.map((product, idx) => {
              const stock = stockLevels[product.id] ?? 0;
              const badge = stock === 0 ? void 0 : stock <= 5 ? "Limited Stock" : product.id === 1 || product.id === 2 ? "Best Seller" : void 0;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1200, margin: "0 auto" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reviews-grid", children: REVIEWS.map((review, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4, marginBottom: 12 }, children: Array.from({ length: review.rating }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Star,
                    {
                      size: 16,
                      fill: "#c6a85b",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: TRUST_BADGES.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 20 }, children: b.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#dfe8dc", fontSize: "0.85rem" }, children: b.label })
                    ]
                  },
                  b.label
                ))
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 28, style: { color: "#c6a85b", marginBottom: 12 } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h3",
                          {
                            style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: "1 1 240px" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Handcrafted natural soaps made with love and the finest botanical ingredients."
                    }
                  )
                ] }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Kishore store, Nagamalai Puthukottai, Melakuilkudi, near SBOA school, Koilam Nagar" })
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, style: { color: "#c6a85b" } }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "a",
                                {
                                  href: "tel:+918825950026",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 14, style: { color: "#25D366" } }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "a",
                                {
                                  href: "https://wa.me/918825950026",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: "1 1 160px" }, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FooterSocial, { Icon: SiInstagram, href: "#", label: "Instagram" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FooterSocial, { Icon: SiFacebook, href: "#", label: "Facebook" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FooterSocial, { Icon: SiYoutube, href: "#", label: "YouTube" })
                  ] })
                ] })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                " Kishore Organic Soaps. All rights reserved."
              ]
            }
          )
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { size: 20, style: { color: "#c6a85b" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, overflowY: "auto", padding: "16px 20px" }, children: cart.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#7a9a8a", fontSize: "0.9rem" }, children: "Your cart is empty" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#aab8b4", fontSize: "0.8rem", marginTop: 4 }, children: "Add some luxurious soaps!" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: cart.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4a6b5c", fontWeight: 500 }, children: "Total:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                          style: {
                ...
                !orderFormOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
    ...
    orderFormOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 20, style: { color: "#25D366" } }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "20px 24px" }, children: orderSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4a6b5c", fontSize: "0.9rem" }, children: "Your order has been sent to WhatsApp. We'll confirm shortly." })
                  ]
                }
                      ...
                      cart.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontWeight: 600, color: "#0f3d2e" }, children: [
                              "₹",
                              item.price * item.qty
                            ] })
                          ]
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        orderErrors.name && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        orderErrors.phone && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            "data-ocid": "order.error_state",
                            style: {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        orderErrors.address && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            "data-ocid": "order.error_state",
                            style: {
    ...
    showScrollTop && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        title: "Back to top",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 20 })
      }
    )
  ] });
}
function NavLink({ href, label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { "data-ocid": "nav.link", href, className: "nav-link", children: label });
}
...
function ProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "product-card", "data-ocid": `products.item.${idx + 1}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "product-img-wrap", style: { position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: product.image, alt: product.name, loading: "lazy" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          stock === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
          ...
          ] }) : stock <= 5 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#7a9a8a", fontSize: "0.75rem" }, children: "per bar" })
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              onClick: stock > 0 ? onAddToCart : void 0,
              disabled: stock === 0,
              style: {
                marginTop: "auto",
